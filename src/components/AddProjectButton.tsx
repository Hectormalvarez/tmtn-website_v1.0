...
const AddProjectButton: React.FC<{ loggedIn: boolean }> = ({ loggedIn }) => {
  if (!loggedIn) return <></>
  return (
    <button className='flex border-2 border-gray-900 p-2 hover:bg-gray-900 hover:fill-white hover:text-white'>
      <svg className='w-8 p-1' viewBox='0 0 1024 1024' xmlns='http://www.w3.org/2000/svg'>
